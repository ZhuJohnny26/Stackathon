  ...
  const MobileView = (props) => {
    ...
    return (
        ...
        <View style={{alignItems:'center', justifyContent:'center', height: 700}}>
          {/* top seperator  */}
          <Text style={{width:800, backgroundColor: 'white', alignSelf: 'flex-start', position: 'absolute', top: 0}} />
          {/* container for the picture, colors, and button */}
        <View style={{backgroundColor: 'gray', width: 340, height: grayContainerHeight, alignSelf: 
        'center', justifyContent:'center', borderRadius: 3,}}>
            {/* picture */}
            <Image
          ...
          <Text style={{ fontSize: 18, color: '#fff' }}>
            ...
            >
              <Text style={{ fontSize: 18, color: '#fff', alignItems:'center'}}>Pick a photo</Text>
            </TouchableOpacity>
          </View>
        </View>
        </View>
